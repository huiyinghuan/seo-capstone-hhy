...
import { Card, CardHeader, CardContent, Typography, LinearProgress, Box,  } from '@mui/material';
  ...
  const createRows = (data) => {
    ...
    return [
      ...
      { label: 'Title', value: data.title || 'No title', requirement: '50 - 60 Characters', valid: validateLength(data.title || '', 30, 80) ? (validateLength(data.title || '', 50, 60) ? true : "partial") : false, recommendation: 'Ensure the title is between 50 - 60 characters' },
      ...
      { label: 'Meta Description', value: data.meta_description || 'No meta description', requirement: '150 - 160 Characters', valid: validateLength(data.meta_description || '', 120, 190) ? (validateLength(data.meta_description || '', 150, 160) ? true : "partial") : false, recommendation: 'Ensure the meta description is between 150 - 160 characters' },
